...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var dialog = self.createDialog({
            ...
            //ajax
            if(self.uploadImageAjax) {
              var imageUploadAjaxAfter = {target:this,fun:uploadbutton.options.afterUpload};
              self.uploadImageAjax.fun.call(self.uploadImageAjax.target,uploadbutton.fileBox[0].files[0],imageUploadAjaxAfter);
              return ;
            }
						// uploadbutton.submit();
						localUrlBox.val('');
